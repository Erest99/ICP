...
int main() {
    ...
    while (!glfwWindowShouldClose(globals.window)) {
        ...
        mesh_teapot.draw_with_material(m_m6, v_m, globals.projectionMatrix, glm::uvec3(15.0f, 10.0f, 15.0f));//[GL CALLBACK]: source = API, type = ERROR, severity = HIGH, ID = '1282', message = 'GL_INVALID_OPERATION error generated. Texture name does not refer to a texture object generated by OpenGL.'
